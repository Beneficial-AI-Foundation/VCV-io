...
@[reducible] noncomputable def instStateT (σ : Type u) :
...
@[reducible] noncomputable def instReaderT (ρ : Type u) :
...
@[reducible] noncomputable def instExceptT (ε : Type u) :
...
@[reducible] noncomputable def instOptionT :
